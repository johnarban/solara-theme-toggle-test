...
def ThemeToggle(
    ...
    # if enforce_default:
    #     theme.dark = theme_to_bool(default_theme)
        
    

    
    print("default_theme", default_theme)  # noqa
    print("theme.dark", theme.dark)  # noqa
    
    
    settingsSummary = f"""
    server settings: {settings.theme.variant.value}
    
    default_to_server: {default_to_server}
    ...
    with solara.Card():    
        solara.Markdown(f"### Initial ThemeToggle Settings\n{settingsSummary}")
